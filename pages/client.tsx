...
export default function ClientPage() {
  ...
  return (
    <Layout>
      ...
      <p>
        The <strong>useSession()</strong>{" "}
        React Hook is easy to use and allows pages to render very quickly.
      </p>
      <p>
        ...
        {" "}
        so that navigation between pages using <strong>useSession()</strong>
        {" "}
        is very fast.
      </p>
      <p>
        The disadvantage of <strong>useSession()</strong>{" "}
